        ...
        <div className='d-flex flex-column align-items-center'>
            <div className="card w-100">
                ...
                <div className="card-body p-2 d-flex flex-column align-items-center">
                    ...
                    {
                        props.displayPurchase ?
                            <React.Fragment>
                                <div>Quantità: {props.UserProduct.bought}</div>
                                <Link to={"/seller/" + props.seller} style={{ color: 'black', textDecoration: 'none' }}>Venditore: {props.seller}</Link>
                            </React.Fragment>
                            :
                            <React.Fragment>
                    ...
                    <button type="button" className="btn btn-sm btn-outline-secondary py-0 px-1" data-bs-toggle="collapse" data-bs-target={"#a" + id}>Scheda tecnica</button>
                </div>
